                                    ...
                                    if (isset($project)) {
                                        foreach ($project as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo 'Rp. ' . number_format($row->perkiraan_anggaran, 0, ',', '.'); ?></td>
                                                <td><?php echo date('d-m-Y H:i', strtotime($row->input_date)) ?></td>
                                                <td><a href="<?php echo site_url('project/download_project/' . $row->file); ?>">Project file</a></td>
                                                <td class="center">
                                                    <a href="#"><i class="icon-trash" title="Hapus Project" data-val="<?php echo $row->id; ?>" name="project"></i></a>
                                                    <!--<a href="<?php echo site_url('project/edit/' . $row->id); ?>"><i class="icon-edit" title="" data-val=""></i></a>-->
                                                    <a class="btn btn-small view_project" id="<?php echo $row->id; ?>"><i class="icon-eye-open"></i> View</a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
