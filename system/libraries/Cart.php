...
class CI_Cart {
    ...
    public function __construct($params = array()) {
        ...
        if ($this->CI->session->userdata('cart_contents') !== FALSE) {
            ...
            $this->_cart_contents['cart_totalberat'] = 0;
        }
    ...
    function _save_cart() {
        ...
        unset($this->_cart_contents['cart_totalberat']);
        ...
        foreach ($this->_cart_contents as $key => $val) {
            ...
            $this->_cart_contents[$key]['subtotalberat'] = ($this->_cart_contents[$key]['berat'] * $this->_cart_contents[$key]['qty']);
        }

        // Set the cart total and total items.
        $this->_cart_contents['total_items'] = $items;
        $this->_cart_contents['cart_total'] = $total;
        $this->_cart_contents['cart_totalberat'] = $totalberat;
    ...
    function totalberat() {
        return $this->_cart_contents['cart_totalberat'];
    }
